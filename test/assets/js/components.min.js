...
Vue.component('y-breadcrumb', {
    ...
    <ol class="breadcrumb">\
    <li class="breadcrumb-item"><a href="https://yangbinji.github.io/test/pages/zh/home/"><i class="fa fa-home" aria-hidden="true"></i> 首页</a></li>\
...
Vue.component('y-side', {
    ...
    template: '\
    <div>\
    <div class="list-group"><h5 class="list-group-item active h5-responsive"><i class="fa fa-font-awesome" aria-hidden="true"></i>\ &nbsp;热点排行 </h5> <a href="#!" class="list-group-item list-group-item-action">“一带一路”国际合作高峰论坛 <span class="badge red">热</span></a> <a href="#!" class="list-group-item list-group-item-action">“一带一路”国际合作高峰论坛成果\
<span class="badge red">热</span></a> <a href="#!" class="list-group-item list-group-item-action">“一带一路”建设者</a>\
...
精彩推荐 </h5> <a href="#!" class="list-group-item list-group-item-action">“一带一路”对咱百姓有啥好处？ <span class="badge green">新\</span></a> <a href="#!" class="list-group-item list-group-item-action">“一带一路”朋友圈为何吸引关注？\
<span class="badge green">新</span></a> <a href="#!" class="list-group-item list-group-item-action">“一带一路”这些重大政策你知道吗？</a>\
</div>\
</div>\
  '
});
