...
$( "head" ).append( '<base href="https://yangbinji.github.io/test/">');
...
Vue.component('y-header', {
    ...
    <a class="navbar-brand" href="pages/zh/home/">\
    <img src="assets/img/svg/camel-48445.svg" height="30" alt=""> </a>\
    <div class="collapse navbar-collapse" id="navbarNav1">\
    <ul class="navbar-nav mr-auto">\
    <li class="nav-item"><a class="nav-link" href="pages/zh/home/"><i class="fa fa-home"\
    aria-hidden="true"></i> 首页<span\
    class="sr-only">(current)</span></a></li>\
    <li class="nav-item"><a href="pages/zh/news/" class="nav-link">新闻资讯</a></li>\
    <li class="nav-item"><a href="pages/zh/photo/" class="nav-link">美图欣赏</a></li>\
    <li class="nav-item"><a href="pages/zh/video/" class="nav-link">视频展示</a></li>\
    <li class="nav-item"><a href="pages/zh/xjps/" class="nav-link">习近平说</a></li>\
