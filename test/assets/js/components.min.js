...
Vue.component('y-nav', {
    template: '<nav class="navbar navbar-toggleable-md navbar-dark fixed-top scrolling-navbar">\
    <div class="container">\
    ...
    <li class="nav-item active"><a class="nav-link" href="https://yangbinji.github.io/test/pages/zh/home/"><i class="fa fa-home"\
    aria-hidden="true"></i> 首页 <span\
    class="sr-only">(current)</span></a></li>\
    <li class="nav-item"><a href="../news/index.html" class="nav-link">新闻资讯</a></li>\
    <li class="nav-item"><a href="../photo/index.html" class="nav-link">美图欣赏</a></li>\
    <li class="nav-item"><a href="../video/index.html" class="nav-link">视频展示</a></li>\
    <li class="nav-item"><a href="../xjps/index.html" class="nav-link">习近平说</a></li>\
