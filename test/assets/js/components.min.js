...
Vue.component('y-header', {
    ...
    <li class="nav-item"><a href="https://yangbinji.github.io/test/pages/zh/news/" class="nav-link">新闻资讯</a></li>\
    <li class="nav-item"><a href="https://yangbinji.github.io/test/pages/zh/photo/" class="nav-link">美图欣赏</a></li>\
    <li class="nav-item"><a href="https://yangbinji.github.io/test/pages/zh/video/" class="nav-link">视频展示</a></li>\
    <li class="nav-item"><a href="https://yangbinji.github.io/test/pages/zh/xjps/" class="nav-link">习近平说</a></li>\
...
Vue.component('y-footer', {
    template: '\
    <div v-once>\
    <div class="call-to-action"><h4></h4>\
    <ul>\
    <li><a href="#!" class="btn btn-info" rel="nofollow">关于我们</a></li>\
    <li><a href="#!" class="btn btn-default" rel="nofollow">联系我们</a></li>\
    </ul>\
    </div>\
    <div class="footer-copyright">\
    <div class="container-fluid">建议使用现代浏览器访问本站 © 2017 Copyright: <a href="http://www.gxcme.edu.cn/" target="_blank"> 广西机电职业技术学院 <i class="fa fa-external-link" aria-hidden="true"></i></a></div>\
    </div>\
    </div>\
  '
});
