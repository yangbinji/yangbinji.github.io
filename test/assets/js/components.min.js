...
Vue.component('y-header', {
    template: '\
    <nav class="navbar navbar-toggleable-md navbar-dark fixed-top scrolling-navbar" v-once>\
    <div class="container">\
    <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse"\
    data-target="#navbarNav1" aria-controls="navbarNav1" aria-expanded="false"\
    aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>\
    <a class="navbar-brand" href="https://yangbinji.github.io/test/pages/zh/home/">\
    <img src="https://yangbinji.github.io/test/assets/img/svg/camel-48445.svg" height="30" alt=""> </a>\
    <div class="collapse navbar-collapse" id="navbarNav1">\
    <ul class="navbar-nav mr-auto">\
    <li class="nav-item"><a class="nav-link" href="https://yangbinji.github.io/test/pages/zh/home/"><i class="fa fa-home"\
    aria-hidden="true"></i> 首页<span\
    class="sr-only">(current)</span></a></li>\
    <li class="nav-item"><a href="https://yangbinji.github.io/test/pages/zh/traffic/" class="nav-link">交通运输</a></li>\
    <li class="nav-item"><a href="https://yangbinji.github.io/test/pages/zh/tour/" class="nav-link">旅游观光</a></li>\
    <li class="nav-item"><a href="https://yangbinji.github.io/test/pages/zh/delicacy/" class="nav-link">美食佳肴</a></li>\
    <li class="nav-item"><a href="https://yangbinji.github.io/test/" class="nav-link">欢迎页</a></li>\
    <li class="nav-item"><a class="nav-link">English</a></li>\
    </ul>\
    <form class="form-inline waves-effect waves-light"><input class="form-control" type="text"\
    placeholder="站内搜索"></form>\
    </div>\
    </div>\
    </nav>\
  '
...
Vue.component('y-footer', {
    template: '\
    <div v-once>\
    <div class="call-to-action"><h6 class="h5-responsive">北宋张载有四言：为天地立心，为生民立命，为往圣继绝学，为万世开太平。 </h6>\
    <h6 class="h5-responsive">今之一带一路，势必继往开来！</h6>\
    </div>\
    <div class="footer-copyright">\
    <div class="container-fluid">© 2017 Copyright: <a href="http://www.gxcme.edu.cn/" target="_blank"> 广西机电职业技术学院 <i class="fa fa-external-link" aria-hidden="true"></i></a></div>\
    </div>\
    </div>\
  '
});
new Vue({
    ...
    data:{
        classObject:{
            'page-footer':true,
            'center-on-small-only':true
        }
    }
});

Vue.component('y-back-to-top', {
    template: '\
    <div v-once>\
   <button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored mdl-color--light-blue" id="back-to-top">\
    <i class="fa fa-angle-up" aria-hidden="true"></i>\
        </button>\
    <div class="mdl-tooltip" data-mdl-for="back-to-top">\
    返回顶部\
    </div>\
    </div>\
  '
...
Vue.component('y-breadcrumb', {
    props: ['first','firsturl','second','secondurl','third','thirdurl','fourth','fourthurl','active'],
    template: '\
    <div class="container mt-5" v-once>\
    <ol class="breadcrumb">\
    <li class="breadcrumb-item">当前位置：<a href="https://yangbinji.github.io/test/pages/zh/home/"><i class="fa fa-home" aria-hidden="true"></i> 首页</a></li>\
    <li class="breadcrumb-item" v-if="this.first"><a :href="firsturl">{{ first }}</a></li>\
    <li class="breadcrumb-item" v-if="this.second"><a :href="secondurl">{{ second }}</a></li>\
    <li class="breadcrumb-item" v-if="this.third"><a :href="thirdurl">{{ third }}</a></li>\
    <li class="breadcrumb-item" v-if="this.fourth"><a :href="fourthurl">{{ fourth }}</a></li>\
...
Vue.component('y-side', {
    template: '\
    <div v-once>\
    <div class="list-group"><h5 class="list-group-item active h5-responsive"><i class="fa fa-font-awesome" aria-hidden="true"></i>\ &nbsp;热点排行 </h5> <a href="#!" class="list-group-item list-group-item-action">“一带一路”国际合作高峰论坛 <span class="badge red">hot</span></a> <a href="#!" class="list-group-item list-group-item-action">“一带一路”国际合作高峰论坛成果\
<span class="badge red">hot</span></a> <a href="#!" class="list-group-item list-group-item-action">“一带一路”建设者</a>\
<a href="#!" class="list-group-item list-group-item-action">“一带一路”在这里</a></div>\
<div class="divider-new"></div>\
    <div class="list-group"><h5 class="list-group-item active h5-responsive"><i class="fa fa-heart" aria-hidden="true"></i> &nbsp;\
精彩推荐 </h5> <a href="#!" class="list-group-item list-group-item-action">“一带一路”对咱百姓有啥好处？ <span class="badge green">new\</span></a> <a href="#!" class="list-group-item list-group-item-action">“一带一路”朋友圈为何吸引关注？\
<span class="badge green">new</span></a> <a href="#!" class="list-group-item list-group-item-action">“一带一路”这些重大政策你知道吗？</a>\
</div>\
</div>\
  '
});
